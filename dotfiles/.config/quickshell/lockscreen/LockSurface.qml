...
Rectangle {
    ...
    readonly property var phrases: [["仏", "陀", "の", "勇", "猛", "果", "敢", "武", "士"], ["黒", "鴉", "の", "翼"], ["月", "下", "美", "人", "剣"], ["桜", "散", "る", "戦", "場"], ["龍", "神", "の", "怒", "り"], ["夜", "叉", "の", "如", "く"], ["一", "期", "一", "会"], ["七", "転", "び", "八", "起", "き"], ["風", "林", "火", "山", "陰", "雷"], ["血", "染", "め", "の", "月", "光"], ["千", "本", "桜", "散", "華"], ["闇", "夜", "の", "刺", "客"], ["不", "死", "身", "の", "武", "士"], ["鋼", "の", "意", "志"], ["武", "士", "道"], ["風", "林", "火", "山"], ["一", "騎", "当", "千"], ["天", "下", "無", "双"], ["義", "を", "見", "て", "せ", "ざ", "る", "は", "勇", "な", "き", "な", "り"], ["百", "戦", "錬", "磨"], ["不", "撓", "不", "屈"], ["烈", "火", "の", "如", "く"], ["極", "意", "を", "極", "め", "る"], ["闇", "を", "切", "り", "裂", "く", "光"]]
    readonly property list<string> translations: ["The Bhudda's most courageous samurai", "Wings of the black crow", "The sword of beauty under the moonlight", "The battlefield where the cherry blossoms fall", "The wrath of the Dragon God", "Like a demon", "Treasure each encounter", "Fall seven times, rise eight", "wind, forest, fire, mountain, shadow, thunder", "The bloodstained moonlight", "Thousand cherry blossom falling", "Assassin of the dark night", "Warrior of Immortality", "A will of steel", "Bushido", "As fast as wind, as quiet as the forest, as daring as fire, and as immovable as the mountain", "A match for a thousand warriors", "No power can rival, unparraleled existance", "There is no valor in a person that ceases righteous behaviour", "The skill and heart trained in numerous battles", "The spirit that does not give in to difficulty", "The burning fire in one's heart", "Pursue the very essense of swordsmanship", "The flash of hope in the darkness"]

    readonly property int phraseIndex: Math.floor(Math.random() * 24)
