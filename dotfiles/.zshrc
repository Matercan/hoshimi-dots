...
zstyle ':fzf-stab:complete:nvim:*' fzf-preview 'bat $realpath'
zstyle ':fzf-stab:complete:mkdir:*' fzf-preview 'eza --icons --color=always $realpath'
zstyle ':fzf-stab:complete:chafa:*' fzf-preview 'chafa $realpath 2>/dev/null || ls $realpath'
